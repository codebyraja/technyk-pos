...
Public Class crptDebitEnquiry
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CardManagement.crptDebitEnquiry.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptDebitEnquiry
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptDebitEnquiry = New crptDebitEnquiry
        rpt.Site = Me.Site
        Return rpt
    End Function
