...
Public Class CrptChequeReturnLetter
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CrptChequeReturnLetter.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CardManagement.CrptChequeReturnLetter.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_SignatureChequeReturnLetter() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCrptChequeReturnLetter
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrptChequeReturnLetter = New CrptChequeReturnLetter
        rpt.Site = Me.Site
        Return rpt
    End Function
