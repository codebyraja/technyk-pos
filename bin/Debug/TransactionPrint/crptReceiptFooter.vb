...
Public Class crptReceiptFooter
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CardManagement.crptReceiptFooter.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptReceiptFooter
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptReceiptFooter = New crptReceiptFooter
        rpt.Site = Me.Site
        Return rpt
    End Function
