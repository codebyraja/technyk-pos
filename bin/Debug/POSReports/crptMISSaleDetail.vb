...
Public Class crptMISSaleDetail
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FNBManagement.crptMISSaleDetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptMISSaleDetail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptMISSaleDetail = New crptMISSaleDetail
        rpt.Site = Me.Site
        Return rpt
    End Function
